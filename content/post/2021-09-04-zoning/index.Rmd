...
```{r plot, fig.width=4, fig.align='center'}
...
This post is the first of a part of a larger project- my [pluto-panel](https://github.com/tfarley10/pluto-panel/tree/main/dbt)
...
[^1]: [taken from here](https://timogrossenbacher.ch/2016/12/beautiful-thematic-maps-with-ggplot2-only/)
